...
"use strict";angular.module("users").controller("RegisterDialogCtrl",["$timeout","$scope","$mdDialog","$http","$location","Authentication",function($timeout,$scope,$mdDialog,$http,$location,Authentication){$scope.authentication=Authentication,$scope.dialogCancel=function(){$mdDialog.cancel()},$scope.dialogRegister=function(){$http.post("/api/auth/register",$scope.credentials).success(function(response){$scope.authentication.user=response,$mdDialog.hide(),$location.path("/planning")}).error(function(response){$scope.error=response.message})}}]);
"use strict";angular.module("users").controller("SignInDialogCtrl",["Authentication","$http","$scope","$location","$mdDialog",function(Authentication,$http,$scope,$location,$mdDialog){$scope.authentication=Authentication,$scope.dialogCancel=function(){$mdDialog.cancel()},$scope.dialogSignIn=function(){$http.post("/api/auth/signin",$scope.credentials).success(function(response){$scope.authentication.user=response,console.log(response),$mdDialog.hide(),$location.path("/planning")}).error(function(response){$scope.error=response.message})}}]);